...
using Moq;
using Xunit;
using AwesomeApp.Core.ProjectAggregate.Handlers;
using AwesomeApp.Core.ProjectAggregate.Events;

namespace AwesomeApp.UnitTests.Core.Handlers
{
    public class ItemCompletedEmailNotificationHandlerHandle
    {
        ...
        {
            await _handler.Handle(new ItemBoughtEvent(new Item()), CancellationToken.None);
